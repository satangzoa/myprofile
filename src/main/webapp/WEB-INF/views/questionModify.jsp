							...
							<table border="0" cellspacing="0" cellpadding="15">
								<form action="questionModifyOk" method="post" name="board_frm">
									...
									<tr>
										...
										<td><input class="input_type01" type="test" name="qname" value="${qdto.qname }" ></td>
									</tr>
									<tr>
										<td><span class="content_text01">QUESTION </span></td>
										<td><textarea class="textarea_type01"  rows="5" clos="30" name="qcontent"  >${qdto.qcontent}</textarea></td>
									</tr>
									<tr>
